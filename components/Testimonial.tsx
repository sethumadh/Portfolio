...
function Testimonial() {
  ...
  const testimonialLinks = [
    {
      src: images.daniel_ram,
      readMore: readMoreT1,
      setReadmore: setreadMoreT1,
      href: "https://www.linkedin.com/in/daniel-block-dev/",
      name: "Daniel Ramirez",
      title: "Software Engineer",
      title1: "Software Engineer",
      work: "Worked together in Labrys",
      work1: "Team Member",
      smallContent: `"During my time at Labrys, I had the great fortune to work alongside Sethumadhavan. He's ability to think creatively and devise novel approaches to fixing bugs in code is awe-inspiring.`,
      extraContent: ` Sethumadhavan is dogged and thorough when it comes to Architecture design. Sethumadhavan will be a great addition to any group he joins. In addition to giving Sethumadhavan my highest recommendation, I am also pleased to call him a friend."`,
    ...
    },
    {
      ...
      href: "https://www.linkedin.com/in/sruthi-u-01529317/",
      name: "Sruthi Unnikrishnan",
      title: "Project Manager",
      title1: "Project Manager / Co-founder",
      work: "Worked together in Bright ",
      work1: "Team Member - Bright",
      smallContent: `"During my time working on Bright a Project for School Management Software, I had the pleasure of working alongside Sethu who is the creator and lead developer of the project. I was impressed by his ability to communicate his problems and in the same breath find the solution to it. Sethu`,
      extraContent: `is more than capable of writing clean and effective code. Sethu has great understanding of architectural patterns and goes beyond. I highly recommend Sethu because I believe he would make a fine addition to anyone's team"`,
    },
  ]
